...
// packages/plugin-runtime/track.js
var require_track = __commonJS({
  "packages/plugin-runtime/track.js"(exports2, module2) {
    ...
    async function runTrack2(runtime2, transformInput) {
      try {
        ...
        runtime2.enqueueHookEvent(input);
        runtime2.wakeShipper();
      } catch (error) {
        runtime2.appendLog("hook", "Failed to capture hook event", {
          error: error instanceof Error ? error.message : "unknown_error"
        });
      }
      process.stdout.write("{}");
...
// packages/cursor-plugin/hooks/track.js
var runtime = require_runtime();
var { runTrack } = require_track();
runTrack(runtime);
